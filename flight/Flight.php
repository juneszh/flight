 ...
 * @method  static void json($data, $code = 200, $encode = true, $charset = "utf-8", $encodeOption = 0, $encodeDepth = 512) Sends a JSON response.
 * @method  static void jsonp($data, $param = 'jsonp', $code = 200, $encode = true, $charset = "utf-8", $encodeOption = 0, $encodeDepth = 512) Sends a JSONP response.
